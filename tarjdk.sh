...
wget https://github.com/termux/termux-elf-cleaner/releases/download/v2.1.1/termux-elf-cleaner
...
findexec jreout | xargs -- ./termux-elf-cleaner --api-level 19
findexec jdkout | xargs -- ./termux-elf-cleaner --api-level 19
